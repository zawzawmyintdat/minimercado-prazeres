...
import fumeiroData from '../data/fumeiro'
import '../css/Products-pages.css'
import banner from '../images/Products-pages/products-pages-image-Fumeiro.webp'

export default function FumeiroRegional(){
    const fumeiroItems = fumeiroData.map(data => {
        return (
            <ProductsDisplayer 
                key={data.id}
    ...
    return (
        <div className="products">
            ...
            <h2 className="products__title">Fumeiro Regional</h2>
